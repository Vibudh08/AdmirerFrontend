...
const Footer = () => {
  return (
    <footer className="bg-white border-t  border-[#7B48A5] text-black mt-[40px] pt-[50px] ">
      <div className="max-w-7xl mx-auto px-3 py-3 w-[90%] mb-[50px] m-auto max-sm:w-full max-sm:mb-[20px] mt-[60px] max-sm:mt-[30px]">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 md:grid-cols-1 gap-x-2 gap-y-1 text-gray-600 max-sm:text-sm">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 md:grid-cols-1 space-y-1 text-gray-600 max-sm:text-sm">
          ...
          {/* Right Section */}
          <div>
            <h3 className="font-semibold mb-3">EXPERIENCE ADMIRER ON MOBILE</h3>
            <Link to="">
      ...
      <div className="w-[90%] max-sm:w-full px-3 py-3 mb-8 m-auto max-sm:block flex justify-between mt-[40px] max-sm:mt-[20px]">
        <div className="max-sm:mb-3 text-gray-600">
          ...
          <p>201301, Uttar Pradesh, India</p>
        </div>
        <div className="mt-8 max-sm:mt-2 text-gray-600">
          <p>BTJ Alpha Technology Private Limited company</p>
          <p>CIN: U62099UP2025PTC215855</p>
          <p>GSTIN: 09AANCB2020R1ZB</p>
        </div>
      </div>
