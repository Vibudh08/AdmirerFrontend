...
const Index: React.FC<IndexProps> = ({
  ...
  const priceDetails: PriceDetail[] = [
    ...
    { label: "Platform Fee", value: platformFee, isFree: platformFee === "Free" },
    { label: "Shipping Fee", value: shippingFee, isFree: shippingFee === "Free" },
  ];
      ...
      <div className="w-[35%] p-5 py-6 border bg-white border-[#eaeaec]">
        ...
        <div className="mb-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="px-3 py-1 border border-[#7B48A5] text-sm font-semibold text-[#7B48A5] hover:bg-[rgb(245,245,245)]">
              APPLY
            </button>
          </div>
        </div>
